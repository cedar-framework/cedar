...
/* Headers for functions implemented in Fortran */
void MSG_TSETUP_INT(int* numproc, int* myproc, int* ptrn,
...
void MSG_TP_SETUP_INT(int* la_size, int* eid_s, int* gc_ld, int* gc_eid,
