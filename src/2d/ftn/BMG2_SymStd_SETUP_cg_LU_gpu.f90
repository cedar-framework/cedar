      SUBROUTINE BMG2_SymStd_SETUP_cg_LU_gpu(&
     &                SO, II, JJ, NStncl, ABD, NABD1, NABD2,&
     &                IBC&
     &                ) BIND(C,NAME='BMG2_SymStd_SETUP_cg_LU_gpu')
...
! -------------------------------------------------------
      ...
      IF ( NStncl.EQ.5 ) THEN
         ...
         IF( IBC.EQ.BMG_BCs_indef_per_xy&
     ...
     &                 - SO(2,3,KNW) - SO(3,2,KNW)
            ...
            !
            CALL dpotrf_gpu('U', N, ABD, NABD1, INFO)
            !
         else
            KK=1
            ABD(1,1) = SO(2,2,KO)
...
! ====================
      ...
      RETURN
END SUBROUTINE BMG2_SymStd_SETUP_cg_LU_gpu
