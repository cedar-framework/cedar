...
C
      ...
      INTEGER   IC, I, IIC1, IICF, IICF1, IICF2, IIF1, IPN,
...
c$$$         DO IC = 2,IIC1
c$$$            WRITE(*,*) 'FOR IC ',IC
c$$$            WRITE(*,*) -SOC(IC,JC+1,KNW),-SOC(IC,JC+1,KS),
c$$$     &           -SOC(IC+1,JC+1,KSW)
c$$$            WRITE(*,*) -SOC(IC,JC,KW),SOC(IC,JC,KO),-SOC(IC+1,JC,KW)
c$$$            WRITE(*,*) -SOC(IC,JC,KSW),-SOC(IC,JC,KS),
c$$$     &           -SOC(IC+1,JC,KNW)
c$$$            WRITE(*,*) -SOC(IC,JC+1,KNW)-SOC(IC,JC+1,KS)
c$$$     &           -SOC(IC+1,JC+1,KSW)
c$$$     &        -SOC(IC,JC,KW)+SOC(IC,JC,KO)-SOC(IC+1,JC,KW)
c$$$     &        -SOC(IC,JC,KSW)-SOC(IC,JC,KS)
c$$$     &           -SOC(IC+1,JC,KNW)
c$$$         ENDDO
c$$$      ENDDO
