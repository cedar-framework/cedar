#ifndef CEDAR_2D_SOLVER_GPU_CEDAR_H
#define CEDAR_2D_SOLVER_GPU_CEDAR_H
...
#include <cedar/2d/gpu/redist_solver.h>
...
template<class fsten>
	class solver: public multilevel<exec_mode::mpi, level_container<level2mpi, fsten>,
                                        fsten, cdr2::gpu::mpi::solver<fsten>>
{
public:
...
solver(mpi::stencil_op<fsten> & fop) : parent::multilevel(fop), comm(fop.grid().comm)
	...
	std::size_t compute_num_levels(mpi::stencil_op<fsten> & fop);
        ...
        virtual cdr2::gpu::mpi::grid_func solve(const cdr2::gpu::mpi::grid_func & b) override;

        virtual void solve(const cdr2::gpu::mpi::grid_func & b, cdr2::gpu::mpi::grid_func & x) override;
